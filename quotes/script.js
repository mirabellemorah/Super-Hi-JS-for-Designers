...
const pages = [
    ...
    { copy: `For it is not in success where true character is revealed but in failure. - Black Manta`, background: "#ff1f56", circle: "#00ce4c" },    // 12
    { copy: `The world is full of magical things patiently waiting for our senses to grow sharper. - W.B. Yeats`, background: "ff9ca5", circle: "#000" },    // 13
]
